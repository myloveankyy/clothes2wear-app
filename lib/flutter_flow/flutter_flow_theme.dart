...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD239AA);
  late Color secondary = const Color(0xFFD23988);
  late Color tertiary = const Color(0xFFE6B2D4);
  late Color alternate = const Color(0xFFF8C8E0);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA500A1);
  late Color secondary = const Color(0xFFD48BB0);
  late Color tertiary = const Color(0xFFC58FBB);
  late Color alternate = const Color(0xFFEAB0C6);
  ...
  late Color accent3 = const Color(0xFF7CB342);
