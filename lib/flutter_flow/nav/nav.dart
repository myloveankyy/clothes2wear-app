...
class AppStateNotifier extends ChangeNotifier {
  ...
  Clothes2WearProductionAuthUser? initialUser;
  Clothes2WearProductionAuthUser? user;
  ...
  void update(Clothes2WearProductionAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ChangeAddressWidget.routeName,
          path: ChangeAddressWidget.routePath,
