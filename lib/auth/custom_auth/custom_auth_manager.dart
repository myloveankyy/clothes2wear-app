...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    clothes2WearProductionAuthUserSubject.add(
      Clothes2WearProductionAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Clothes2WearProductionAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Clothes2WearProductionAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Clothes2WearProductionAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    clothes2WearProductionAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
Clothes2WearProductionAuthUser? currentUser;
