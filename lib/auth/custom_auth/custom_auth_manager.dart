...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    clothes2WearNCBAuthUserSubject.add(
      Clothes2WearNCBAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Clothes2WearNCBAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Clothes2WearNCBAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Clothes2WearNCBAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    clothes2WearNCBAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
Clothes2WearNCBAuthUser? currentUser;
